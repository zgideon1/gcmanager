<template>
    <div class="menu">
        <div v-if="$route.path === '/ownerhome/employees'" class="menu" id="menuBackground">
                <button type='button' class="menuButton" id="menuEditingButton"  @click="navigateTo('editemployees')">
                    <span class="menuButtonText">Edit<br> Employees</span>
                </button>

                <button type='button' class="menuButton" id="menuSchedulesButton" @click="navigateTo('employeeschedules')">
...
<script setup>
    ...
    function navigateTo(page) {
        router.push(`/ownerhome/employees/${page}`)
    }
